// ✅ English Promo Version
// File: PromoLandingPageEN.tsx
import { useNavigate } from 'react-router-dom';

const PromoLandingPageEN = () => {
  ...
  const content = {
    title: 'Bug to Byte',
    subtitle: 'Where young minds ignite with code!',
    heading: 'Unlock the Future:\nAI & Coding Adventures!',
    subheading: 'Engaging lessons for curious minds aged 7 to 17',
    features: [
      { text: 'Boosts Confidence', icon: '🚀', color: 'bg-green-200' },
      { text: 'Strengthens Logic', icon: '🧠', color: 'bg-red-200' },
      { text: 'Enhances Creativity', icon: '🎨', color: 'bg-yellow-200' },
      { text: 'Builds Problem-Solving', icon: '💡', color: 'bg-blue-200' },
    ],
    cta: 'Claim Your FREE Discovery Lesson!',
    bottomCTA: 'Enroll Today! Start Their Coding Journey',
  };

  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100 flex flex-col items-center px-4 py-12 sm:py-20 font-sans relative overflow-hidden">
      {/* Background Shapes */}
      ...
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-xl p-6 md:p-12 flex flex-col lg:flex-row items-center justify-between gap-8 relative z-10 border-4 border-purple-300 transform transition-transform duration-500 hover:scale-[1.01]">
        ...
        <div className="flex-1 flex justify-center lg:justify-end mt-8 lg:mt-0">
          <img
            ...
            alt="Kid learning AI and coding"
...
export default PromoLandingPageEN;
