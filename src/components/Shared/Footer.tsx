...
const Footer: React.FC = () => {
  return ( 
  <footer className="bg-gradient-to-r from-gray-700 via-indigo-500 to-gray-900 text-white py-6 px-4 w-full shadow-inner">
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
    {/* Socials */}
    <div className="flex space-x-6 mb-4 md:mb-0">
      {[{ icon: FaFacebook, url: "https://facebook.com" },
    ...
    {/* Copyright */}
    <div className="text-md text-center">
      <p className="mb-1">Empowering kids and teens with code! 🚀</p>
      <p>© {new Date().getFullYear()} Bug to Byte. All rights reserved.</p>
    </div>
  </div>
</footer>
